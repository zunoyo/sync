...
const PW_COLORS = ['', '#f3727f', '#ffa42b', '#ffa42b', 'var(--accent)', 'var(--accent)'];
    ...
    >
      <div className="auth-modal-card">
        <div className="auth-logo" style={{ justifyContent: 'center', marginBottom: 20 }}>
          ...
          <span className="auth-logo-text">SYNC</span>
        </div>
            ...
            {mode === 'signup' && (
              <div id="modal-signup-view">
                ...
                <div className="auth-field">
                  ...
                  <input id="modal-su-display" type="text" placeholder="SYNC 사용자" autoComplete="name"
        ...
        {showSpotifyPrompt && (
          <div style={{ textAlign: 'center', padding: '16px 0 4px' }}>
            ...
            <a
              ...
              style={{ display: 'block', width: '100%', background: 'var(--accent)', border: 'none', color: '#000', padding: 13, borderRadius: 50, fontSize: 13, fontWeight: 700, textDecoration: 'none', fontFamily: 'inherit', marginBottom: 10, boxSizing: 'border-box' }}
            >
              Spotify 연동하기
            </a>
            <button
