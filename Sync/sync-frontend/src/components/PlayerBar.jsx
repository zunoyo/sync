...
export default function PlayerBar() {
  const {
    ...
    isShuffle, repeatMode, togglePlay, nextTrack, prevTrack,
    toggleShuffle, toggleRepeat, seek, setVolume,
    isPanelOpen, togglePanel, isUsingSpotify,
    isLiked, toggleLike, openPanel, panelTab, setPanelTab,
  } = usePlayer();
  ...
  function toggleQueue() {
    if (isPanelOpen && panelTab === 'queue') {
      setPanelTab('nowplaying');
    } else {
      setPanelTab('queue');
      openPanel();
    }
    ...
    <div className="player-wrapper">
      <div className="player-bar">
        ...
        <div className="player-right">
          ...
          <button className="ctrl-btn" title="다음 곡 목록" onClick={toggleQueue}>
