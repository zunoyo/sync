/**
 * SOUNDWAVE — Player Bar Component (하단 재생바)
  ...
  <div class="player-bar">
    ...
    <div class="player-center">
      <div class="player-controls">
        ...
        <button class="ctrl-btn" title="이전 곡">
        ...
        <button class="ctrl-btn" title="다음 곡">
    ...
    <div class="player-right">
      ...
      <button class="ctrl-btn" title="다음 곡 목록" onclick="RightPanel.switchTab('queue');RightPanel.open()">
