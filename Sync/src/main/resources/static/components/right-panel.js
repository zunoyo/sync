/**
 * SYNC — Right Panel Component (Now Playing)
    ...
    <div class="rp-tab-content" data-tab="nowplaying">
      <div class="rp-now-playing">
        ...
        <div class="rp-track-info" style="width:100%">
          <div class="rp-track-header">
            ...
            <div style="display:flex;align-items:center;gap:4px;flex-shrink:0">
              <button id="rp-add-btn" class="icon-btn" title="플레이리스트에 추가"
                      onclick="PlaylistPicker.open(Player.getState().currentTrack, this)">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z"/>
                </svg>
              </button>
              <button id="rp-like-btn" class="icon-btn" title="좋아요"
                      onclick="PlaylistPicker.toggleLike(Player.getState().currentTrack, this)">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div class="rp-controls" style="width:100%">
          ...
          <button class="ctrl-btn" onclick="prevTrack()" title="이전">
          ...
          <button class="ctrl-btn" onclick="nextTrackBtn()" title="다음">
