...
<header class="topbar">
  ...
  <div class="topbar-right">
    <div style="position:relative">
      ...
      <div class="home-mode-toggle" id="home-mode-toggle">
        <button class="active" id="home-mode-grid-btn" onclick="GalaxyView.hide()">⊞ 그리드 뷰</button>
        <button id="home-mode-galaxy-btn" onclick="GalaxyView.show()">🌌 갤럭시 뷰</button>
      </div>
    </div>
