...
const PW_COLORS = ['', '#e0637a', '#e0a458', '#e0a458', '#d9c08f', '#d9c08f'];
...
export default function AuthModal() {
  ...
  function quickDemo() {
    setLoginForm({ email: 'demo@sync.kr', password: 'demo1234' });
    doLogin('demo@sync.kr', 'demo1234');
  }
            ...
            {mode === 'login' && (
              <div id="modal-login-view">
                ...
                <div className="auth-demo">
                  🎵 체험 계정으로 바로 시작하기<br />
                  <strong>demo@sync.kr</strong> / <strong>demo1234</strong><br />
                  <button
                    onClick={quickDemo}
