      ...
      <div className="profile-hero">
        ...
        <div className="profile-info">
          ...
          <div className="profile-stats">
            <div className="profile-stat"><b>28</b>좋아요</div>
            <div className="profile-stat"><b>8</b>플레이리스트</div>
            <div className="profile-stat"><b>6</b>팔로잉</div>
          </div>
        </div>
      </div>
  ...
  if (status.connected) {
    ...
    return (
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 14, fontWeight: 700, color: expired ? '#ffa500' : '#d9c08f' }}>
            {expired ? '⚠ 토큰 만료' : '✅ 연동됨'}
          </div>
