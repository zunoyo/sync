  ...
  return (
    <>
      <div className="detail-hero h-playlist">
        <div className="detail-hero-bg" style={{ backgroundImage: playlist?.coverUrl ? `url(${playlist.coverUrl})` : undefined }} />
          ...
          <div className="detail-hero-info">
            ...
            <div className="detail-action-row">
              ...
              <button
                ...
                style={{ borderColor: shared ? 'var(--accent)' : undefined, color: shared ? 'var(--accent)' : undefined }}
              >
