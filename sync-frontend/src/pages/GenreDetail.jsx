...
export default function GenreDetail() {
  ...
  return (
    <>
      <div className="detail-hero h-genre">
        <div className="detail-hero-bg" />
        <div className="detail-hero-content">
          <div className="detail-hero-art">{meta.emoji}</div>
          <div className="detail-hero-info">
            <div className="detail-hero-type">장르</div>
            <h1 className="detail-hero-name">{genreName}</h1>
            <div className="detail-hero-meta">
              <span>{tracks === null ? '불러오는 중...' : `${tracks.length} TRACKS · ${totalMin} MIN`}</span>
            </div>
